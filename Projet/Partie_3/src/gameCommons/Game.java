...
public class Game {
	...
	public boolean testLose() {
		// TODO
		//System.out.println("x_y :"+this.frog.getPosition().absc+" "+this.frog.getPosition().ord);
 ...
 */
	...
	public void update() {
		graphic.clear();
		environment.update(frog.getDirection());
		this.graphic.add(new Element(frog.getPosition(), Color.GREEN));

		if (testLose()){
			String res ="You Lose, your score: "+this.environment.getScore();
